...
|![Widerspruch](./images/contradiction.png)| **Widersprüchliche Notwendigkeit:** Für diese Zelle soll die Nummer 4 gleichzeitig notwendig und indirekt unzulässig sein. Wenn das Sudoku noch erfolgreich gelöst werden soll, müssen ein oder mehrere der bisherigen Nummernsetzungen zurückgenommen werden. Tritt während der automatischen Ausführung eine solche Zelle auf, schaltet der Solver in den Rückwärts-Modus um.|
