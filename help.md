...
|![Automatische Selektion](./images/autoSelectted.png){:width="100px"}|**Automatisch selektierte Zelle:** mit einem Hidden Single. Wolkiger Hintergrund.|
|![Manuelle Selektion](./images/manualSelected.png){:width="100px"}|**Manuell selektierte Zelle:** mit drei Kandidaten.|
